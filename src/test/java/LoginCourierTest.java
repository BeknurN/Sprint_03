...
public class LoginCourierTest {
    ...
    public void newCourierCanLogInTest() {
     ...
     */
    @Test
    @DisplayName("Курьер успешно авторизуется только со всеми обязательными полями")
    public void loginСourierSuccessfullyLogsWithAllRequiredFieldsTest() {
